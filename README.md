...
* In the Creative Cloud 2017.x release in Oct 2017, all creative applications use CEP 8. Extensions and add-ins must be built on at least CEP 6 infrastructure.
...
For developing CEP 8.0 HTML/JavaScript extensions for host applications

**Documentation**
* [CEP 8.0 HTML Extension Cookbook](https://github.com/Adobe-CEP/CEP-Resources/blob/master/CEP_8.x/CEP_8.0_HTML_Extension_Cookbook.pdf)
