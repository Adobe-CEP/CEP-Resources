...
- [CEP 12 HTML Extension Cookbook](#cep-12-html-extension-cookbook)
  - [Overview](#overview)
    - [CEP Extensions](#cep-extensions)
    - [Extension Types](#extension-types)
    - [Applications Integrated with CEP](#applications-integrated-with-cep)
    - [Chromium Embedded Framework (CEF)](#chromium-embedded-framework-cef)
    - [Browser Features supported by CEP](#browser-features-supported-by-cep)
      - [HTTP Cookie](#http-cookie)
  - [Development and Debugging](#development-and-debugging)
    - [Migration from CEP 11 to CEP 12](#migration-from-cep-11-to-cep-12)
    - [Migration from CEP 10 to CEP 11](#migration-from-cep-10-to-cep-11)
    - [Migration from CEP 9 to CEP 10](#migration-from-cep-9-to-cep-10)
    - [Migration from CEP 8 to CEP 9](#migration-from-cep-8-to-cep-9)
      - [NodeJS](#nodejs)
        - [New Symbols in the global context](#new-symbols-in-the-global-context)
        - [Accessing nodejs APIs in iframe](#accessing-nodejs-apis-in-iframe)
        - [JS Lib Break due to node symbols (possible for many other libraries)](#js-lib-break-due-to-node-symbols-possible-for-many-other-libraries)
        - [require path is absolute instead of relative](#require-path-is-absolute-instead-of-relative)
      - [Contexts in CEP](#contexts-in-cep)
    - [Development Machine Setup](#development-machine-setup)
    - [Signing extensions](#signing-extensions)
    - [Debugging Unsigned Extensions](#debugging-unsigned-extensions)
      - [Special notes for macOS 10.9 and higher](#special-notes-for-macos-109-and-higher)
    - [Remote Debugging](#remote-debugging)
    - [Where are the Log Files](#where-are-the-log-files)
      - [PlugPlug Logs](#plugplug-logs)
      - [CEPHtmlEngine Logs](#cephtmlengine-logs)
      - [CEF Log](#cef-log)
    - [Extension Folders](#extension-folders)
    - [CEP HTML Test Extensions](#cep-html-test-extensions)
    - [Extension Manifest](#extension-manifest)
      - [Extension Manifest XSD](#extension-manifest-xsd)
      - [Important Manifest Change for CEP 5.0 Extensions](#important-manifest-change-for-cep-50-extensions)
      - [Important Manifest Change for CEP 7.0 Extensions](#important-manifest-change-for-cep-70-extensions)
      - [Extension Size](#extension-size)
      - [Customize Extension Menu](#customize-extension-menu)
      - [High DPI Panel Icons](#high-dpi-panel-icons)
      - [Dialog Size based on Screen Size](#dialog-size-based-on-screen-size)
    - [Shortcut Keys for HTML Extensions](#shortcut-keys-for-html-extensions)
  - [CEP JavaScript Programming](#cep-javascript-programming)
    - [CEP JavaScript Libraries](#cep-javascript-libraries)
      - [API version](#api-version)
      - [CEP Events](#cep-events)
        - [CSEvent](#csevent)
        - [Listen for and Dispatch CSEvent](#listen-for-and-dispatch-csevent)
          - [addEventListener](#addeventlistener)
          - [dispatchEvent](#dispatchevent)
        - [Communication between Native Point Product and CEP extensions](#communication-between-native-point-product-and-cep-extensions)
        - [Standard Events in Point Products](#standard-events-in-point-products)
        - [Specific Events in Products](#specific-events-in-products)
          - [Photoshop](#photoshop)
        - [Invoke point product's scripts from html extension](#invoke-point-products-scripts-from-html-extension)
      - [Vulcan messages](#vulcan-messages)
        - [Vulcan message](#vulcan-message)
        - [Listen for and Dispatch Vulcan message](#listen-for-and-dispatch-vulcan-message)
      - [Access Application DOM from Html Extension](#access-application-dom-from-html-extension)
      - [Access HTML DOM from extend script](#access-html-dom-from-extend-script)
        - [Sample Code](#sample-code)
      - [Fly-out menu](#fly-out-menu)
      - [Customize Context Menu](#customize-context-menu)
        - [Set and Update Context Menu](#set-and-update-context-menu)
        - [Disable Context Menu](#disable-context-menu)
      - [Get Display Status of HTML Extension Window](#get-display-status-of-html-extension-window)
        - [Two ways to get HTML extension window](#two-ways-to-get-html-extension-window)
        - [Resister "com.adobe.csxs.events.panelWindowStatusChanged" CSXS event](#resister-comadobecsxseventspanelwindowstatuschanged-csxs-event)
        - [Call isWindowVisible API](#call-iswindowvisible-api)
      - [Getting and Changing Extension Content Size](#getting-and-changing-extension-content-size)
        - [Getting Extension Content Size](#getting-extension-content-size)
        - [Changing Extension Content Size](#changing-extension-content-size)
      - [Register invalid certificate error callback](#register-invalid-certificate-error-callback)
      - [Register an interest in specific key events](#register-an-interest-in-specific-key-events)
      - [Set and Get the title of the extension windows](#set-and-get-the-title-of-the-extension-windows)
    - [HI-DPI display](#hi-dpi-display)
    - [Other JavaScript APIs](#other-javascript-apis)
    - [Localization](#localization)
      - [License Locale and locales supported by extension](#license-locale-and-locales-supported-by-extension)
      - [Locale folder structure](#locale-folder-structure)
      - [Sharing localization resources across multiple locales](#sharing-localization-resources-across-multiple-locales)
      - [Localized menu](#localized-menu)
      - [Examples](#examples)
        - [Example 1](#example-1)
        - [Example 2](#example-2)
        - [Example 3](#example-3)
      - [Supporting MENA locales](#supporting-mena-locales)
        - [Extension localization for MENA locales](#extension-localization-for-mena-locales)
    - [Video/Audio Playback](#videoaudio-playback)
    - [WebRTC](#webrtc)
    - [Scroll bar tips](#scroll-bar-tips)
    - [Invisible HTML Extensions](#invisible-html-extensions)
    - [Customize CEF Command Line Parameters](#customize-cef-command-line-parameters)
      - [How to use CEF command line parameters](#how-to-use-cef-command-line-parameters)
      - [Commonly used CEF command parameters](#commonly-used-cef-command-parameters)
    - [HTML Extension Persistent](#html-extension-persistent)
    - [Open URL link in default browser](#open-url-link-in-default-browser)
    - [Interaction between extension and point product during extension unload](#interaction-between-extension-and-point-product-during-extension-unload)
    - [Using Node.js APIs (CEP 6.0 and prior releases)](#using-nodejs-apis-cep-60-and-prior-releases)
      ...
      - [Samples](#samples)
        ...
        - [Use Node.js to download files](#use-nodejs-to-download-files)
    - [Using Node.js APIs (CEP 6.1)](#using-nodejs-apis-cep-61)
      - [Node.js Support](#nodejs-support-1)
    - [Using Node.js APIs (since CEP 7.0)](#using-nodejs-apis-since-cep-70)
    - [Using Node.js APIs (since CEP 10.0)](#using-nodejs-apis-since-cep-100)
    - [Limitation of cep.process.stdout/stderr](#limitation-of-cepprocessstdoutstderr)
    - [Adobe Exchange](#adobe-exchange)
  - [Other JavaScript Information](#other-javascript-information)
    - [Load Multiple JSX files](#load-multiple-jsx-files)
    ...
    - [NPAPI plug-ins](#npapi-plug-ins)
    - [Increase/Decrease font size in HTML Panel](#increasedecrease-font-size-in-html-panel)
  ...
  - [CEPHtmlEngine](#cephtmlengine)
    ...
    - [Ports opened in CEPHtmlEngine](#ports-opened-in-cephtmlengine)
    - [CEF/Chromium Issues](#cefchromium-issues)
...
This cookbook is a guide to creating CEP 12 HTML/JavaScript Extensions for Creative Cloud applications.
...
|-------|---------------------------|-------------------------------|-------------------------------|-------------------------------|
|CEF 3|CEF 3 release branch  3163| CEF 3 release branch 3729| CEF 3 release branch - (88)| CEF 3 release branch - (99)|
|Chromium	| 61.0.3163.91| 74.0.3729.157| 88| 99|
|Node.js	|Node.js 8.6.0| Node.js 12.3.1| Node.js 15.9.0| Node.js 17.7.1|
|CEF/Node integration|Node-Webkit 0.25|Node-Webkit 0.38| Node-Webkit 0.50.1| Node-Webkit 0.62.1|
|v8 | 6.3.292.49 | 7.4.288| 8.7| 9.9.115|
---
...
Update the Node Modules: CEP 12 works with NodeJS 17.7.1 and Node-WebKit v0.62.1 versions. If extensions were build on older version of NodeJS there can be cases where these extensions may not load in CEP 12 due to incompatible node modules. In such cases, the node modules need to be updated which are build with NodeJS version 17.7.1 or higher.

Also Refer [Known issues](./Issues.md) in CEP 12
...
CEP HTML Extensions can be developed on both Windows and macOS platforms. The development machine needs to have the following applications in order to successfully develop CSXS extensions:
 ...
 - Visual Studio Code with the [ExtendScript Debugger plugin](https://marketplace.visualstudio.com/items?itemName=Adobe.extendscript-debug) (This is optional, but may be helpful, particularly use macOS 10.14 or later)
...
If you are in the midst of development and want to bypass the need to sign your extensions, you can bypass the check for extension signatures by editing the CSXS preference properties file, located at:
 ...
 - macOS: In the terminal, type: `defaults write com.adobe.CSXS.12 PlayerDebugMode 1` (The plist is also located at /Users/`<username>`/Library/Preferences/com.adobe.CSXS.12.plist)


These entries will enable debug extensions to be displayed in the host applications. Please note that, CSXS.12 is given with the assumption that, you are developing the extension for CEP 12. If you are developing extension for previous version of CEP, replace 12 with corresponding version number.
...
The **LogLevel** key can be updated at the following location (The application should be restarted for the log level changes to take effect):
 ...
 - Win: `regedit > HKEY_CURRENT_USER/Software/Adobe/CSXS.12`
 - macOS: `/Users/<USERNAME>/Library/Preferences/com.adobe.CSXS.12.plist`
